...
import { COMPANY, formatSwedishOrgNumber } from "@/lib/site";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 md:gap-12 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)] lg:gap-8 xl:gap-10">
          ...
          <div className="min-w-0">
            <h3 className="text-xs font-bold uppercase tracking-wider text-[var(--accent)]">{t("companyDetails")}</h3>
            <ul className="mt-4 space-y-4 text-sm text-white/80">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-start gap-2 text-white/80 hover:text-white"
                >
                  <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[var(--accent)]" aria-hidden />
                  <span className="flex flex-col">
                    <span>{COMPANY.address.street}</span>
                    <span>{COMPANY.address.postalCity}</span>
                  </span>
                </a>
              </li>
              <li>
