      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-lg text-sm leading-relaxed text-white/70">{COMPANY.description}</p>
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-[var(--accent)]">Quick links</h3>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-xs font-bold uppercase tracking-wider text-[var(--accent)]">Contact</h3>
