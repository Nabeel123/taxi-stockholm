        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 space-y-6 text-sm text-white/80 sm:text-base">
            ...
            <section>
              ...
              <p className="mt-2">{t("s5p")}</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white">{t("s6h")}</h2>
              <p className="mt-2">
                {t("s6p", {
                  phone: COMPANY.phoneDisplay,
                  email: COMPANY.emails.bookings,
                })}
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white">{t("s7h")}</h2>
              <p className="mt-2">{t("s7p", { company: COMPANY.legalName })}</p>
            </section>
          </div>
        </div>
      </main>
